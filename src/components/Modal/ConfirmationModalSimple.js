...
const ConfirmationModalSimple = ({
  ...
  return (
    ...
    >
      {/* Background with blur simulation */}
...
export default ConfirmationModalSimple;
...
const styles = StyleSheet.create({
  blurContainer: {
    ...
    width: screenWidth,
    height: screenHeight,
    backgroundColor: 'rgba(0, 0, 0, 0.6)', // Simulación de blur con opacity
  },
  overlay: {
    flex: 1,
